...
if(Select-String -Path $PROFILE -Pattern $profileLine -Quiet -SimpleMatch) {
    Write-Host "It seems PS git shortcuts is already installed..."
    return
}

Write-Host "Adding PS git shortcuts to profile..."
@"

# Load PS git shortcuts profile
$profileLine

"@ | Out-File $PROFILE -Append -WhatIf:$WhatIf -Encoding (Get-FileEncoding $PROFILE)

Write-Host 'PS git shortcuts sucessfully installed!'
